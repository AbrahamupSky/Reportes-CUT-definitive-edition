          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                En este apartado los maestros podran acceder para subir las
                evidencias generadas en el transcurso del semestre.{" "}
              </p>
            </div>
            <div className="text-center">
              <Link to="/upload">
                <button
                  className="btn btn-outline-primary justify-content"
                  type="button"
                >
                  Ir al sitio
                </button>
        ...
        <div className="col Card2" id="maestro2">
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Aqui podras generar el reporte de tus evidencias y actividades
                que has subido durante el semestre.
              </p>
            </div>
            <div className="text-center">
              <Link to="/report">
        ...
        <div className="col Card3" id="jefe">
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Area designada para el Jefe de departamento para la revision de
